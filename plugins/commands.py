...
@Client.on_message(filters.command('ban') & filters.private &  filters.chat(Config.BOT_OWNER))
 def ban_a_user(bot, message):
...
@Client.on_message(filters.command('unban') & filters.private &  filters.chat(Config.BOT_OWNER))
